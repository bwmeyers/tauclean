...
def find_fom_tau_peaks(
    ...
    *,
    ...
    prominence_bounds: tuple[float | None, float | None] = (0.2, None),
    height_bounds: tuple[float | None, float | None] = (0.05, None),
    polyorder: int = 3,
    deriv_order: int = 3,
    ...
    def estimate_best_tau(
        ...
        for series in fom_series:
            ...
            result = find_fom_tau_peaks(
                ...
                prominence_bounds=(0.2, norm_fom_peak_prominance),
                height_bounds=(0.05, norm_fom_peak_height),
                logger=self.logger,
                name=series.name,
            )
